                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/logo-mini.png" alt="Cool">
                                Cool Expense Manager
                            </a>
                        </div>
                        <div class="login-form">
                    <!--action sent to regval.php-->
                            <form action="regval.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Income</label>
                                    <input required class="au-input au-input--full" type="text" name="income" placeholder="Your Income">
                                </div>
                                ...
                                <input type="submit" name="mit" class="au-btn au-btn--blue"></input>
                            </form>
