                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="to" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="enter valid username"value="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Enter Message</label>
                                                <input id="cc-number" name="message" type="textarea" class="form-control cc-number identified visa" value="" data-val="true"
                            ...
                            $date=date('Y-m-d');
                            //insert message
                            $msgins=mysqli_query($conn,"insert into messages(frommsg,tomsg,message,date) values('$name','$toms','$msg','$date')");
                            ...
                            if($msgins)
                            {
                              ...
                              echo "<script>alert('Couldnot send message');</script>";
